		...
		if ($stmt->execute($param)){
			...
			if($r){
				...
				if($r['group_user']==100){ 
					...
					$_SESSION['namaperan'] = "Operator";
				}elseif ($r['group_user']==1000){ 
					$_SESSION['namaperan'] = "Stakeholder";
				}
				
				// if($r["group_user"] == 800){
					header("location:media.php?modul=petataatpbb"); 
				// } else {
					// header("location:office/media.php?modul=dashboard"); 
				// }
