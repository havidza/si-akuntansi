	      ...
	      <div class="modal-body">
			  ...
			  <div class="form-group">
				...
				<select class="select2 form-control" name="group_user" id="group_user"  required="true">
					...
					<option value="1000">Stakeholder</option>
				</select>
			  </div>
	          <div class="form-group">
...
$(function() {
    var table =  $('#example').DataTable( {
		...
		"responsive": true,
		"columns": [
			{ "data": "no" },{ "data": "nama_user" },{ "data": "alamat_user" },{"data": "phone_user" },{ "data": "username_user" },
			{ "data": "group_user" },{ "data": "aksi" }
		]
	});
})
...
function saveData(){
	var a = $('#password_user').val(); var n = a.length; var a2 = a.substring(0,1);	var a3 = a2.charCodeAt(); var a4 = a3+2; var a5 = String.fromCharCode(a4); var u1 = a.substring(1,3); var u2 = a.substring(3,n); var _passfix = $.MD5(u2+a5+u1+a4+'./');
